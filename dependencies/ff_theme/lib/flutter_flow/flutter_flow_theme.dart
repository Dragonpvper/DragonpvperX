...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF13DEBE);
  late Color secondary = const Color(0xFF39D2C0);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF0C0D0E);
  late Color secondaryText = const Color(0xFF2F3535);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4C2713E2);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xA7D1CECE);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFB91A23);
  late Color info = const Color(0xFF000000);

  late Color warningDark = Color(0xFFF2A404);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryBackground = const Color(0xB30C0C0C);
  late Color secondaryBackground = const Color(0xFF121212);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xB2262D34);
  late Color success = const Color(0xFF393939);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFF9B161E);
